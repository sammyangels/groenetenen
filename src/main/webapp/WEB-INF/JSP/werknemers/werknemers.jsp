...
<body>
    ...
    <table>
        <thead><tr>
            <th>
                <c:url value="" var="url"><c:param name="sort" value="voornaam"/></c:url>
                <a href="${url}">Voornaam</a>
            </th>
            <th>
                <c:url value="" var="url"><c:param name="sort" value="familienaam"/></c:url>
                <a href="${url}">Familienaam</a>
            </th>
            <th>
                <c:url value="" var="url"><c:param name="sort" value="filiaal.naam"/></c:url>
