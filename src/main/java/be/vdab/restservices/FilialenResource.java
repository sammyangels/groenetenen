...
@XmlRootElement @XmlAccessorType(XmlAccessType.FIELD) @JsonAutoDetect(fieldVisibility = JsonAutoDetect.Visibility.ANY)
class FilialenResource extends ResourceSupport {
    ...
    public FilialenResource() {
    }

    public FilialenResource(Iterable<Filiaal> filialen, EntityLinks entityLinks) {
